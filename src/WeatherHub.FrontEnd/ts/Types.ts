...
export class DtoConverter {
    ...
    public toStationStatistics(stationStatisticsDto: StationStatisticsDto) : StationStatistics {
        ...
        let stationDayStatistics: StationDayStatistics = {
            ...
            dewpointHighTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.dewpointHighTime),
            dewpointLowC: stationStatisticsDto.dayStatistics.dewpointLowC,
            dewpointLowTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.dewpointLowTime),
            heatIndexHighC: stationStatisticsDto.dayStatistics.heatIndexHighC,
            heatIndexHighTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.heatIndexHighTime),
            pressureHighMbar: stationStatisticsDto.dayStatistics.pressureHighMbar,
            pressureHighTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.pressureHighTime),
            pressureLowMbar: stationStatisticsDto.dayStatistics.pressureLowMbar,
            pressureLowTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.pressureLowTime),
            ...
            relativeHumidyHighTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.relativeHumidyHighTime),
            relativeHumidityLow: stationStatisticsDto.dayStatistics.relativeHumidityLow,
            relativeHumidyLowTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.relativeHumidyLowTime),
            tempHighC: stationStatisticsDto.dayStatistics.tempHighC,
            tempHighTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.tempHighTime),
            tempLowC: stationStatisticsDto.dayStatistics.tempLowC,
            tempLowTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.tempLowTime),
            totalRainCm: stationStatisticsDto.dayStatistics.totalRainCm,
            windChillLowC: stationStatisticsDto.dayStatistics.windChillLowC,
            windChillLowTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.windChillLowTime),
            windHighMph: stationStatisticsDto.dayStatistics.windHighMph,
            windHighTime: parseISO(dateStr + 'T' + stationStatisticsDto.dayStatistics.windHighTime),
        };

        let statistics: StationStatistics = {
            dayStatistics: stationDayStatistics,
            lastRain: stationStatisticsDto.lastRain ? new Date(stationStatisticsDto.lastRain) : null,
        }
